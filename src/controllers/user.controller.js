...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    const oldAvatarId = user.avatar?._id;
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        // Total no of subscribers of a channel
        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",
        ...
        // Total no of other channels subscribed by a channel
        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",
        ...
        },
        {
            $addFields: {
                ...
                // count of channel subscribed by a channel
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails, updateUserAvatar, getUserChannelProfile, getWatchHistory, updateUserCoverImage };